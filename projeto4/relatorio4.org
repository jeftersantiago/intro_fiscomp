...
** *B4*
  ...
  Analisando o sistema para o caso onde \( \gamma  = \frac{1}{2} \), \( \Omega = \frac{3}{2} \)com \(
\Delta t = 0.03 \) para \( F_0 = 0, F_0 = \frac{1}{2} \text{ e } F_0 = \frac{6}{5} \) temos os
  gráficos conjuntos de para o \( \theta  \) e \( \omega \) em função do tempo.

  #+attr_latex: :width 10cm :height 8cm :placement [!h]
  [[./tarefa-b/b4/tarefa-b4-grafico-omega.pdf]]

  #+attr_latex: :width 10cm :height 8cm :placement [!h]
  [[./tarefa-b/b4/tarefa-b4-grafico-theta.pdf]]
